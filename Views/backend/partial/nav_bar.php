...
<header class="app-header">
    <a class="app-header__logo" href="<?php if ($_SESSION['CurrentUserData']['role_name'] == 'SuperAdmin') {echo baseURL().'/superAdmin';} else {echo baseURL().'/admin';}  ?>"><?php echo constant('APP_NAME')?></a>
