        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <span class="pull-left">All Shows</span>
                    <a href="<?php echo baseURL().'/showForm'; ?>" class="fa fa-plus pull-right text-success" title="Create New"></a>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <span class="pull-right">No Of Record : <?php echo count($shows) ?></span>
                        </div>
                    </div>
                </div>
            </div>
